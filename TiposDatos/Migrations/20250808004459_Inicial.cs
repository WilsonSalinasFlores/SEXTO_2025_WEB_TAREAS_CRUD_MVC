        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ventas_Clientes_ClientesModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VentasModelId = table.Column<int>(type: "int", nullable: false),
                    Create_At = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Update_At = table.Column<DateTime>(type: "datetime2", nullable: false),
                    isDelete = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductosVendidos_Productos_ProductosModelId",
                        column: x => x.ProductosModelId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductosVendidos_Ventas_VentasModelId",
                        column: x => x.VentasModelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductosVendidos_ProductosModelId",
                table: "ProductosVendidos",
                column: "ProductosModelId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductosVendidos_VentasModelId",
                table: "ProductosVendidos",
                column: "VentasModelId");

            migrationBuilder.CreateIndex(
                name: "IX_Ventas_ClientesModelId",
                table: "Ventas",
